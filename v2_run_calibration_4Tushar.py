...
glac_wide_massbaltotal2, model_massbal2 = get_mass_balance(precfactor=2, ddfsnow=0.0051,
                                                          tempchange=3)
...
#                                     tempchange=tempchange)
    model_massbal = pm.Deterministic('model_massbal',
                                     get_mass_balance(precfactor, ddfsnow,
                                                      tempchange))
